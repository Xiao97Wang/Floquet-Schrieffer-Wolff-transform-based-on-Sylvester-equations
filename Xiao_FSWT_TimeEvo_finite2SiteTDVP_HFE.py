...
data=open("HFE_finiteTDVP_EvoPlot_L"+str(L)+"_chi"+str(chi_dmrg)+"_mu"+str(mu)+"_U"+str(U)+"_omega"+str(w)+"_g"+str(g)+".txt",'a+')    #  change to your output directory
...
while Evolved_time < TDVP_Simulation_Time:
    ...
    print("HFE stroboscopic TDVP nD=", np.average(outcome_1.expectation_value("NuNd")), ", occupancy n=", np.average(outcome_1.expectation_value("Ntot")),", at time = ", Evolved_time)
